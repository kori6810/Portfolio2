...
export function Projects() {
  const projectList = [
    {name:'Natures', tools:'CSS, Java Script', mainPic: Natures, webPic: Natures2, type:'Travel Agency Website',
    ...
    {name:'Mini Bank', tools:'Java Script', mainPic: miniBank, webPic: miniBank2, type:'Simple online banking app',
    ...
    {name:'Houzing', tools:'React JS / Styled Component', mainPic: Houzing, webPic: Houzing2, type:'This site is for selling, renting and buying houses.',
    ...
    {name:'Trillo', tools:'CSS, SASS, Flexbox', mainPic: Trillo, webPic: Trillo2, type:'All-in-one-one booking App',
  ...
  const clickExit = ()=>setClick(false)
          ...
          projectList.map((val)=>{
            return(
              <div className="projects__project1 projects__project">
                ...
                <img src={val.mainPic} alt="projects picture" className="projects__img"/>
               <div className="projects__top">
                <h1>{val.name}</h1>
                <h2>{val.tools}</h2>
              </div>
              <div className="projects__bottom">
                <button className="projects__btn--1 projects__btn" onClick={clickHandler}>
                Learn More
               </button>
              </div>
              <div className={click ? 'projects__overlay' : 'projects__none'}>
               <div className={click ? 'projects__learn-more-box' : 'projects__none'}>
                <img src={val.webPic} alt="web picture" className='projects__webpics'/>
                ...
                <div className="projects__content">
                  ...
                  <div className="projects__visit-site-box">
                    <button className="projects__btn--2 projects__btn">
                      <a href={val.link} className="projects__link">
                        Visit Site
                      </a>
                    </button>

                    <FaTimes className='projects__exit' onClick={clickExit}/>
